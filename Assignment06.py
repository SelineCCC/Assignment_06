...
# JingyinChen, 2021-Aug-14, Modified File to Add Functionalities
# JingyinChen, 2021-Aug-15, Modified File to Add Line213: unpacking the tuple of 
#the three strings from user input.
...
class DataProcessor:
    ...
    def add_table(dicInput, table):
        ...
        Args:
            dicInput (new dict from userinput): the dict that holds the data from 
        userinput
        ...
        """
        intID = int(strID)
        dicInput = {'ID': intID, 'Title': strTitle, 'Artist': strArtist}
        table.append(dicInput)
...
class FileProcessor:
    ...
    def write_file(file_name, table):
        ...
        """Save the user input data to the file, by casting the dicts in the 2D
        list as lists first, then cast the integer ID as string ID
...
class IO:
    ...
    def input_data():
        ...
        Returns:
            A tuple of three strings: ID, CD Title, and Artist Name 
...
while True:
    ...
    # 3.3 process add a CD
        ...
        DataProcessor.add_table(dicRow, lstTbl)
